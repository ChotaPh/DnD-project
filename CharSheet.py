...
class CharSheet:
    ...
    def __init__(self, char_race, char_class, char_lv):
        ...
        self.equip_l_armor = Armor.light_armor_class
        self.equip_m_armor = Armor.medium_armor_class
        self.equip_h_armor = Armor.heavy_armor_class
...
#       return modifier_score
    ...
    def get_proficiency(self):
        ...
        if level <= 4:
            ...
            return 6
    def get_equiment(self):
        print(Armor("Hide"))

        return
if __name__ == '__main__':
    def print_char_info(char_sheet):
